...
<html>
    ...
    <body>
        ...
        if (!empty($_GET['alterar'])) {
            ...
            $listarservicos = $listarservicosDAO->listarONE($id);
            ?>


            <div class="escala-2 fullSize transitionENTRADA displaynone">
                <form method="POST" action="controladorModulosAlterar.php?modulo=servico" onsubmit="return ValidaCadastroModulo();" class="cadastrofull formularioCadastro displaynone transitionENTRADA" id="formularioCadastro" name="formularioCadastro">

                    <input class="input-black titulo transitionENTRADA displaynone" style="font-size: 40px;font-weight: 700;background: none;border: none;margin: 20px;" type="text" id="titulo" name="titulo" value="<?php echo $listarservicos['titulo']; ?>" placeholder="Título serviço">
                    ...
                    <div class="nopadding cadastrofull-groups transitionENTRADA displaynone">
                        <div class="cadastrofull-group1">
                            ...
                            <input style="display: none" type="text" name="idservico" value="<?php echo $id; ?>">

                            <select class="input-black select-white categoria" name="categoria" id="categoria" onclick="limpar('servico')">
                                <option value="<?php echo $listarservicos['categoria']; ?>"><?php echo $listarservicos['categoria']; ?></option>
                            ...
                            <select class="input-black select-white servico2" name="servico" id="servico"  onmouseenter="servicos('categoria')" onfocus="servicos('categoria')">
                                <option value="<?php echo $listarservicos['servico']; ?>"><?php echo $listarservicos['servico']; ?></option>
                            ...
                            <select class="input-black select-white modoservico" name="modoservico" id="modoservico">
                                <option value="<?php echo $listarservicos['modoservico']; ?>"><?php echo $listarservicos['modoservico']; ?></option>
                                <option value="Diaria">Diaria</option>
                                <option value="Serviço">Serviço</option>
                            </select>

                            <input class="input-black valor" type="text" placeholder="Valor" name="valor" id="valor" value="<?php echo $listarservicos['valor']; ?>">
                        ...
                        <div class="cadastrofull-group1">
                            ...
                            <div class="nopadding csscheckbox-caixa colorTEXT" style="text-align: center;margin-bottom: 20px">
                                ...
                                <?php
                                $dias = explode(",", $listarservicos['diasdisponiveis']);
                                ?>
                            ...
                            <textarea class="input-black descricao mark" name="descricao" id="descricao"><?php echo $listarservicos['descricao']; ?></textarea>


                            <input type="submit" class="input-submit" value="Finalizar" style="margin-left: 10px;">
                            <input type="button" class="input-submit input-button" value="Cancelar" onclick="redirection('../View/QuadroP.php')">
                        </div>
                ...
                <div class="mensagem">
                    <div class="display-table">
                        <div class="centralizar">
                            ...
                            $valor = $_POST["valor"];
                            $datacadastroservicos = date('y-m-d');
                            ...
                            $cadastrarServico = new ClasseServico();
                            $cadastrarServico->setIdusuario($idusuario);
                            $cadastrarServico->setServico($servico);
                            $cadastrarServico->setCategoria($categoria);
                            $cadastrarServico->setTitulo($titulo);
                            $cadastrarServico->setModoservico($modoservico);
                            $cadastrarServico->setValor($valor);
                            $cadastrarServico->setDiasdisponiveis($diasdisponiveis);
                            $cadastrarServico->setDescricao($descricao);
                            $cadastrarServico->setDatacadastroservico($datacadastroservicos);

                            $cadastrarServicoDAO = new ServicoDAO();
                            $cadastrar = $cadastrarServicoDAO->cadastrarServico($cadastrarServico);
