...
<html>
    ...
    <body>
                                    ...
                                    <div class="opcoes">
                                        <div class="display-table">
                                            <div class="centralizar">
                                                ...
                                                <p class="Subtitulos" style="margin-top: 20px;">Contratador</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="opcoes">
                                        <div class="display-table">
                                            <div class="centralizar">
                                                <p class="conteudo-icone-text" style="text-align: left;margin: 0;font-weight: 300">
                                                    <b class="Subtitulos" style="fon">Modo selecionado para contratar serviços.</b><br><br>
        ...
        <div class="escala-2 fullSize transitioncadastro displaynone">
            <form method="POST" action="../../Controladores/controladorModuloc.php" onsubmit="return ValidaCadastroModulo();" class="cadastrofull formularioCadastro displaynone transitioncadastro" id="formularioCadastro" name="formularioCadastro">

                <input class="input-black titulo displaynone transitioncadastro" style="font-size: 40px;font-weight: 700;background: none;border: none;margin: 20px;" type="text" id="titulo" name="titulo" placeholder="Título">
                ...
                <div class="nopadding cadastrofull-groups displaynone transitioncadastro">
                    <div class="cadastrofull-group1">
                        ...
                        <select class="input-black select-white servico2" name="servico" id="servico"  onmouseenter="servicos('categoria')" onfocus="servicos('categoria')">
                            <option value="">Selecionar serviço a ser contratado</option>
                        ...
                        <label class="colorTEXT">Modo de contratação</label>
                        ...
                        <input class="input-black valor" style="display: none" type="text" placeholder="Valor" name="valor" id="valor" value="0">

                    </div>

                    <div class="cadastrofull-group1">

                        <label class="colorTEXT">Preferência de dias</label>
